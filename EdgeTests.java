...
public class EdgeTests{
    ...
    public static void main(String[] args){
        ...
        //test case 1: constuctor, distance(), other(), vertices(), equals()
        {
            // given
            ...
            System.out.println("After creating a new Edge between v1 and v2 with the same magniture, but with the order reverse:");
