...
public class ServerBehaviorTests {
    ...
    public static void serverBehaviorTests() {
        ...
        // Validates waiting totals after staggered arrivals
        {
            ...
            double minWait = j1.getProcessingTimeNeeded() + j2.getProcessingTimeNeeded() + j3.getProcessingTimeNeeded();
            assert server.getTotalWaitingTime() >= minWait : "Waiting time should include processing";
        }
